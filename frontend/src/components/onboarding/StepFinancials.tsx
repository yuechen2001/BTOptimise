  ...
  return (
    <div>
      ...
      <p className="section-subtitle">
        We need your income and savings details to compute grant eligibility, loan capacity, and milestone cash flow.
      </p>
      ...
      {isDeferred && (
        <div className="card" style={{ background: '#fffbeb', borderColor: '#fbbf24', marginBottom: 'var(--sp-lg)' }}>
          <p style={{ fontSize: '0.85rem', color: '#92400e' }}>
            As a {p.employmentStatus === 'student' ? 'student' : 'national serviceman'}, your income assessment
            will be deferred. We will use $0 assessed income for maximum grant estimation.
          </p>
        </div>
      )}
      ...
      <div className="form-group">
        ...
        <span className="hint">Liquid savings you can allocate to downpayment and fees</span>
        <input
          className="form-input"
          type="number"
          min={0}
